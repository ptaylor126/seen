...
export function AnimatedLogo({
    ...
    return (
        ...
        >
            ...
            <Path d="M522.159 110.51H603.746V160.822H522.159V110.51Z" fill="#7A3960" />
            <Rect
                x={297.794}
                y={110.51}
                width={81.5873}
            ...
            <AnimatedG animatedProps={eyeProps}>
                <Circle
                    ...
                    fill="url(#iris_right)"
                />
                <Circle cx="544.141" cy="125.699" r="10.9457" fill="#7A3960" />
                <Path
            ...
            <AnimatedG animatedProps={eyeProps}>
                <Circle
                    ...
                    fill="url(#iris_left)"
                />
                <Circle cx="318.057" cy="125.699" r="10.9457" fill="#7A3960" />
                <Path
