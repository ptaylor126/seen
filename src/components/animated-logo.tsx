...
import { palette, paletteV2, THEME_V2_ENABLED } from '@/theme/theme';

// Brand fill for the mark's solid shapes. V1: the plum accent. V2
// exploration: the lavender accent. The gold wordmark gradient is a
// separate pending decision and deliberately stays as-is.
const BRAND_FILL = THEME_V2_ENABLED ? paletteV2.accent : palette.light.accent;
// Pupils are near-black ink under V2, NOT accent — the wordmark flip
// initially sent all six fills to accent and the eyes went purple. Only
// the letterforms carry the brand colour. V1 keeps the original plum.
const PUPIL_FILL = THEME_V2_ENABLED ? '#0B0D26' : palette.light.accent;
import Svg, {
    Circle,
    Defs,
    Ellipse,
...
export function AnimatedLogo({
    ...
    return (
        ...
        >
            ...
            <Path d="M522.159 110.51H603.746V160.822H522.159V110.51Z" fill={BRAND_FILL} />
            <Rect
                x={297.794}
                y={110.51}
                width={81.5873}
            ...
            <AnimatedG animatedProps={eyeProps}>
                <Circle
                    ...
                    fill="url(#iris_right)"
                />
                <Circle cx="544.141" cy="125.699" r="10.9457" fill={PUPIL_FILL} />
                <Path
            ...
            <AnimatedG animatedProps={eyeProps}>
                <Circle
                    ...
                    fill="url(#iris_left)"
                />
                <Circle cx="318.057" cy="125.699" r="10.9457" fill={PUPIL_FILL} />
                <Path
